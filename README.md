...
suggestions, text-to-speech, and a searchable translation history. It is built
in Python with [CustomTkinter](https://github.com/TomSchimansky/CustomTkinter)
...
- **Noun mode.** For short inputs, the word is placed in a short contextual
  phrase to improve single-word translations, with an automatic fall back to a
  direct translation.
